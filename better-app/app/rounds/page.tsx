  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <section style={{ 
        ...
        <nav style={{ display: 'flex', justifyContent: 'flex-start', borderBottom: '1px solid #f5ebe0' /* Lighter color for lines */ }}>
      <a
        href='#'
        ...
        style={{
          ...
          borderBottom: activeTab === 'Active' ? '3px solid #FFA500' : 'none',  // Highlight active tab
      ...
      <a
        ...
        style={{
          ...
          borderBottom: activeTab === 'Archived' ? '3px solid #FFA500' : 'none',  // Highlight active tab
      ...
      <div style={{ paddingTop: '15px' }}>
        ...
        <div className="feed-card" style={{ color: '#FFFFFF' }}> {/* Add color: white to the card */}
          ...
          <div className="card-content">
            ...
            <p style={{ color: '#FFFFFF' }}>Six emerging writers compete for cash and exposure in a three-round tournament.</p> {/* Add color: white to p */}
            <ul style={{ color: '#FFFFFF' }}> {/* Add color: white to ul */}
